...
@Slf4j
class CustomTabDemoInstanceTabProvider extends AbstractInstanceTabProvider {
	protected MorpheusContext morpheusContext
	protected Plugin plugin

	CustomTabDemoInstanceTabProvider(Plugin plugin, MorpheusContext morpheusContext) {
	...
	HTMLResponse renderTemplate(Instance instance) {
		...
		def nonce = morpheus.services.webRequest.getNonceToken()
	...
	@Override
	String getCode() {
		return "customTabDemo-instanceTab"
	}
